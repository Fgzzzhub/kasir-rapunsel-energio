...
async function assertBusinessAccess(auth: Exclude<Awaited<ReturnType<typeof requireApiAuth>>, NextResponse>, businessId: string) {
  ...
  return business.slug === selectedSlug ? null : "Admin tidak dapat mengubah absensi di luar bisnis terpilih.";
}
...
export async function POST(request: Request) {
  ...
  const accessError = await assertBusinessAccess(auth, parsed.data.businessId);
